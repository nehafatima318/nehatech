  ...
  return (
      ...
      <div className="text-center z-10 px-4">
              ...
              <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto ">
                  ...
                  scalable web applications. My goal is to build    
                  solutions that offer both exceptional performance
              ...
              <div className="flex justify-center space-x-4 ">
                ...
                hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]] hover:bg-blue-500/10">Contact Me</a>
